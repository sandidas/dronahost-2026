...
export default function PricingSection2({ data }: Props) {
  const section = data.managedHostingAbstractSection;
    ...
    <Section padding="xl" className="bg-gray-50 dark:bg-gray-900">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex justify-center lg:justify-center">
          ...
          {/* Illustration (goalkeeper style SVG) */}
              <Image
              src={section.illustration?.src || "/images/home/pricingSection3.svg"}
              alt={section.illustration?.alt || "Hosting illustration"}
              width={400}
              height={300}
              className="relative object-contain w-full max-w-2xl"
            />
        </div>
